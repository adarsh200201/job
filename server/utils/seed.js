  ...
  const sample = [
    {
      ...
      jobDescription: 'Join Acme Tech as a Software Engineer. Work on modern web applications and grow your skills.',
      ...
      requirements: ['B.Tech (CSE/IT)', 'DSA knowledge', 'Problem solving'],
    ...
    },
    {
      ...
      education: 'B.Tech/B.E (CSE/IT)',
      batch: '2025 Batch',
      jobDescription: 'A hands-on internship building UI components with React and Bootstrap.',
      description: 'A hands-on internship building UI components with React and Bootstrap.',
      responsibilities: ['Build UI components', 'Code reviews', 'Learn best practices'],
      requirements: ['HTML/CSS/JS', 'React basics', 'Good communication'],
