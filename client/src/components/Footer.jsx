        ...
        <div className="container footer-grid">
          ...
          <div className="footer-col footer-col-about">
            ...
            <div className="footer-social-buttons mt-3">
              <a href="https://chat.whatsapp.com/LVpuUJluTpUEdIc4daAemQ" onClick={triggerAd} target="_blank" rel="noopener noreferrer" className="footer-social-btn whatsapp">
              ...
              <a href="https://t.me/nextjobpost" onClick={triggerAd} target="_blank" rel="noopener noreferrer" className="footer-social-btn telegram">
