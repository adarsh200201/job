    ...
    const fetchData = async () => {
      ...
      try {
        ...
        try {
          ...
          console.log('Falling back to searching in all jobs...');
        ...
        if (!currentJob) {
          console.warn(`Job with slug "${slug}" not found`);
          setJob(null);
          setLoading(false);
          return;
        }
        ...
        <div className="col-12 col-lg-8">
          ...
          {(job.whatsapp || job.telegram) && (
            <div className="mb-4 contact-links">
              {job.whatsapp && (
                <div className="contact-item contact-item-whatsapp">
                  <div className="contact-icon whatsapp-icon-bg">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" fill="#fff" width="24" height="24">
              ...
              {job.telegram && (
                <div className="contact-item contact-item-telegram">
                  <div className="contact-icon telegram-icon-bg">
          ...
          <div className="job-header-section mb-4">
            <div className="d-flex align-items-start justify-content-between gap-3 mb-3">
              ...
              <a className="btn btn-success btn-apply-sticky" href={job.applyLink} onClick={(e) => handleApply(e, job.applyLink)} target="_blank" rel="noopener noreferrer">Apply Now</a>
            </div>
